...
#if 0
    rt_kprintf("YAFFS2: %s, block_start: %d, block_end: %d, pages_per_block: %d, page_size: %d, oob_size: %d\n",
               pcMountingPath,
               psMtdNandDev->block_start,
               psMtdNandDev->block_end,
               psMtdNandDev->pages_per_block,
               psMtdNandDev->page_size,
               psMtdNandDev->oob_size);
#endif
