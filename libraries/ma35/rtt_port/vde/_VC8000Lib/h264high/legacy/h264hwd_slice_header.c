...
/*------------------------------------------------------------------------------
    ...
    Function name: h264bsdCheckPpsId
        ...
        Outputs:
            ...
            sliceType       value is stored here
...
u32 h264bsdCheckPpsId(strmData_t *pStrmData, u32 *picParamSetId, u32 *sliceType)
{
...
/*------------------------------------------------------------------------------
    ...
    Function: h264bsdCheckFieldPicFlag
        ...
        Outputs:
            fieldPicFlag    value is stored here
...
/*------------------------------------------------------------------------------
    ...
    Function: h264bsdBottomFieldFlag
        ...
        Outputs:
            bottomFieldFlag value is stored here
